...
As mentioned in [Send your first fleet](/guides/send-your-first-fleet) sending fleets require 2 transactions. One will make your fleet leaves its origin planet. And the second need to be performed when the fleet reaches its destination.
...
![](../../../assets/gitbook/2021-12-06_1920x1080_054.png)
